...
OUT_TABLE="$SUM_DIR/p14_random_5rounds_table_${TS}.csv"
OUT_JSON="$SUM_DIR/p14_random_5rounds_clean_${TS}.json"
...
picked={}
for r in range(1,6):
    pat=str(sum_dir / f"p14_random_round{r:02d}_clients_*.csv")
