...
OUT_TABLE="$SUM_DIR/p15_backdoor_5rounds_table_${TS}.csv"
OUT_JSON="$SUM_DIR/p15_backdoor_5rounds_clean_${TS}.json"
...
picked={}
for r in range(1,6):
    pat=str(sum_dir / f"p15_backdoor_round{r:02d}_clients_*.csv")
