...
OUT_DIR="$RUN_DIR/p7_baseline/round04/client_logs"
...
OUT_CSV="$SUM_DIR/p7_baseline_round04_clients_${TS}.csv"
OUT_JSON="$SUM_DIR/p7_baseline_round04_latency_pct_${TS}.json"
