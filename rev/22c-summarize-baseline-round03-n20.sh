...
OUT_DIR="$RUN_DIR/p7_baseline/round03/client_logs"
...
OUT_CSV="$SUM_DIR/p7_baseline_round03_clients_${TS}.csv"
OUT_JSON="$SUM_DIR/p7_baseline_round03_latency_pct_${TS}.json"
